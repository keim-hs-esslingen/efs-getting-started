# Use the middleware-core library as a Consumer
...
1. [Autowire the provided components](#Autowire-the-provided-components)
    1. [ServiceDirectoryProxy](#ServiceDirectoryProxy)
    1. [ConsumerService](#ConsumerService)
...
## Autowire the provided components

The next step is to autowire those components provided by the middleware-core library, that are useful to you. The two components of interest are the following ones:
...
The `ConsumerService` component offers you all methods you need